        ...
        children: [
          ...
          Card(
            ...
            child: ListTile(
              ...
              leading: Image.asset('assets/drawer/home_icon.png',scale: 2,),
          ...
          DrawerItem(onTap: (){}, title: 'রুটিন', icon: 'assets/drawer/routine_icon.png'),
          DrawerItem(onTap: (){}, title: 'এক্সপার্ট ব্লগ', icon: 'assets/drawer/blog_icon.png'),
          DrawerItem(onTap: (){
            Get.to(const AboutUsScreen());
          }, title: 'আমাদের সম্পর্কে', icon: 'assets/drawer/about_icon.png'),
...
class DrawerItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Text(title,
        style: const TextStyle(color: Color(0xff37568E),
            fontSize: 22,
            fontWeight: FontWeight.w600
        ),
      ),
